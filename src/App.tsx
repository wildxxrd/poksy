...
function App() {
  return (
    <div className='flex-col bg-zinc-700 text-white items-center py-5 justify-center text-center h-screen'>
        <h1 className=' py-5 text-4xl text-center font-extrabold font-bagel md:text-5xl lg:text-6xl '>Poksy</h1>
          <p className='font-bagel'>You can't expect to win every single battle, 
            but love's worth fighting for, and if you're <br /> 
